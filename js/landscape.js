...
var canvas,
    ...
    upHeld,
    downHeld,
    loaded = false; // set some *GASP* global vars
var fov = 70,
    depth = 80,
    steps = 8,
    maph = 300,
    ...
    resy = 150,
    fps = 30,
    speed = 1.8; //engine config
var rayShift = mapw / resx,
    rotShift = fov / resx,
    pi = 3.14159265359; // some precalculations to improve engine speed
